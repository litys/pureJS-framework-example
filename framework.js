(function () { // self-invoked function
    ...
    var addController = function (name, constructor) {
        ...
        var element = document.querySelector('[a-controller=' + name + ']');
        if (!element) return;
        ...
        var bindings = {};
        Array.prototype.slice.call(element.querySelectorAll('[a-bind]')).map(function (element) {
            var boundValue = element.getAttribute('a-bind');
